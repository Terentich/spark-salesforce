...
class DefaultSource extends RelationProvider with SchemaRelationProvider with CreatableRelationProvider {
  @transient private val logger = Logger.getLogger(classOf[DefaultSource])
  ...
  private def updateSalesforceObject(username: String,
                                     password: String,
                                     login: String,
                                     version: String,
                                     sfObject: String,
  ...
  private def createBulkRelation(sqlContext: SQLContext,
                                 username: String,
                                 password: String,
                                 login: String,
                                 version: String,
    ...
    val timeout = try {
      ...
      case _: Exception => throw new Exception("timeout must be a valid integer")
    }
    ...
    if (pkChunking) {
      ...
      if (chunkSize.isDefined) {
        try {
          ...
          case _: Exception => throw new Exception("chunkSize must be a valid integer")
        }
  ...
  private def writeInSalesforceWave(username: String,
                                    password: String,
                                    login: String,
                                    version: String,
                                    datasetName: String,
